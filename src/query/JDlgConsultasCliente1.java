 ...
 * @author u10549640177
 */
public class JDlgConsultasCliente1 extends javax.swing.JDialog {
    ControleCliente Controlecliente;
    ClienteDAO clienteDAO;
    /**
     * Creates new form JDlgConsultasClientes
     */
    public JDlgConsultasCliente1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setTitle("Cliente consultas");
        setLocationRelativeTo(null);
        Controlecliente = new ControleCliente();
        clienteDAO = new ClienteDAO();
        List lista = clienteDAO.listALL();
        Controlecliente.setList(lista);
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addComponent(jTxtIdade, javax.swing.GroupLayout.PREFERRED_SIZE, 126, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jBtnConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnConsultarActionPerformed
        ...
        if (jTxtNome.getText().equals("") && jTxtIdade.getText().equals("")){
            List lista = clienteDAO.listALL();
            Controlecliente.setList(lista);
        } else {
            if (!jTxtNome.getText().equals("") && !jTxtIdade.getText().equals("")){
                List lista = clienteDAO.listNomeIdade(jTxtNome.getText(), jTxtIdade.getText());
                Controlecliente.setList(lista);
            } else {
                if (! jTxtNome.getText().equals("")){
                    ...
                    List lista = clienteDAO.listIdade(jTxtIdade.getText());
                    Controlecliente.setList(lista);
                   jTable1.setModel(Controlecliente);
                }
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDlgConsultasCliente1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDlgConsultasCliente1 dialog = new JDlgConsultasCliente1(new javax.swing.JFrame(), true);
