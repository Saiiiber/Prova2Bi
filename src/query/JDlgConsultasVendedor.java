...
public class JDlgConsultasVendedor extends javax.swing.JDialog {
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addComponent(jTxtEndereco, javax.swing.GroupLayout.PREFERRED_SIZE, 126, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jBtnConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnConsultarActionPerformed
        ...
        if (jTxtNome.getText().equals("") && jTxtEndereco.getText().equals("")){
            List lista = vendedorDAO.listALL();
            Controlevendedor.setList(lista);
        } else {
            if (!jTxtNome.getText().equals("") && !jTxtEndereco.getText().equals("")){
                List lista = vendedorDAO.listNomeEndereco(jTxtNome.getText(), jTxtEndereco.getText());
                Controlevendedor.setList(lista);
            } else {
                if (! jTxtNome.getText().equals("")){
                    ...
                    List lista = vendedorDAO.listEndereco(jTxtEndereco.getText());
                    Controlevendedor.setList(lista);
                   jTable1.setModel(Controlevendedor);
                }
            }
